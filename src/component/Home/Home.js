...
const Home = () => {
    ...
    return (
        <div>
            <div className='home-container container mt-5 mb-3 row ' >

                <div className='  mx-auto col-12 col-lg-7 d-flex flex-column align-items-center justify-content-center '>
